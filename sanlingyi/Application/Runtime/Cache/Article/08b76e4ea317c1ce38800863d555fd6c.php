...
//                   alert(1);
			...
			<div class="cont-cont">
				...
				<?php echo ($de["content"]); ?>
                    ...
                    <div class="wx" style="padding-bottom:15px;border-top:1px solid #e5e5e5">
                        ...
                        <div style="text-align: center;margin-top:5px">
                            <img src="/sanlingyi/Public/Article/images/1.png" style="width: 13px;margin-top: 15px;"/><br />
                            <a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.rongke.yixin.android" style=""><img src="/sanlingyi/Public/Article/images/2.png" style="width: 100px;margin-top: -12px;"/></a>
                            ...
                            <img src="/sanlingyi/Public/Article/images/1.png" style="width: 13px;"/><br />
                            <div style="width: 50%;text-align: center;margin-top:-12px;float: left;">
                                <img src="/sanlingyi/Public/Article/images/3.png" style="width: 60%;"/>
                            ...
                            <div style="width: 50%;text-align: center;margin-top:-12px;float: left;padding:10px ;">
                                <img src="/sanlingyi/Public/Article/images/4.png" style="width: 60%;position: relative;top:-7px"/>
        		...
        		<p class="fx">
        			<span  onclick="sh_evoke_shares()">
			        	<img src="/sanlingyi/Public/Article/images/fx.png" class="fximg"/>
			        	<span>
			        		分享
			        	</span>
		        	</span>
		        	...
		        	<span is_save="0" id="add_favorite" style="margin-left:0.5em;">
			        	 <?php
 if(!$is_save){ ?>
                        <img src="/sanlingyi/Public/Article/images/sc.png" class="scimg"/>
                        <?php } else { ?>
                        <img src="/sanlingyi/Public/Article/images/scw.png" class="scimg"/>
                        <?php } ?>
			        	<span>
			        		收藏
			        	</span>
 ...
 if($evalute<=10){ echo ''; }else{ ?>
    ...
    <?php } else { ?>
    <div class="shafa">
        <img src="/sanlingyi/Public/Article/images/shafa.png" class="shafaimg"/>
        <div class="">
 ...
 if($evalute==0){ echo '<a><span style="font-size: 11px;float: right;color:#000">暂无评论</span></a>'; }else{ ?>
        ...
        <script src="/sanlingyi/Public/Article/js/mui.min.js"></script>
        <script>
            //赞
                     ...
                     $.post(save_url,{'aid':snaliyi_artid,'is_save':is_save},function(data){
                        if(data==1){
                            if(is_save==0) {
                                ...
                                $('#add_favorite img').attr('src', "/sanlingyi/Public/Article/images/scw.png");
                            }else if(is_save==1){
                                $('#add_favorite').attr('is_save','0');
