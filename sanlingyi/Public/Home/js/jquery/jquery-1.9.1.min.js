...
(function (e, t) {
        ...
        init: function (e, n, r) {
            ...
            if ('string' == typeof e) {
                if (i = '<' === e.charAt(0) && '>' === e.charAt(e.length - 1) && e.length >= 3 ? [
                    ...
                    e,
                    null
                ] : N.exec(e), !i || !i[1] && n) return !n || n.jquery ? (n || r).find(e)  : this.constructor(n).find(e);
                if (i[1]) {
    ...
    b.extend = b.fn.extend = function () {
        ...
        r = o[i],
        s !== r && (c && r && (b.isPlainObject(r) || (n = b.isArray(r))) ? (n ? (n = !1, a = e && b.isArray(e) ? e : [
    ...
    b.event = {
        ...
        add: function (e, n, r, o, a) {
            ...
            if (v) {
                ...
                (h = u[g]) || (h = u[g] = [
                ], h.delegateCount = 0, p.setup && p.setup.call(e, o, m, f) !== !1 || (e.addEventListener ? e.addEventListener(g, f, !1)  : e.attachEvent && e.attachEvent('on' + g, f))),
    ...
    function (e, t) {
        ...
        c = st.setDocument = function (e) {
            ...
            return n !== p && 9 === n.nodeType && n.documentElement ? (p = n, f = n.documentElement, d = a(n), T.tagNameNoComments = at(function (e) {
             ...
             : function (e, t) {
                ...
                0,
                0
            ].sort(v), T.detectDuplicates = u, p)  : p
        },
        ...
        function vt(e) {
            ...
            for (; o > u; u++) if (n = i.relative[e[u].type]) f = [
                ht(gt(f), n)
            ];
             else {
    ...
    b.extend({
        filter: function (e, t, n) {
            return n && (e = ':not(' + e + ')'),
            1 === t.length ? b.find.matchesSelector(t[0], e) ? [
                t[0]
            ] : [
            ] : b.find.matches(e, t)
        },
    ...
    function Ot(e, n) {
        ...
        if (!s) for (s = [
        ], r = e.childNodes || e; null != (o = r[a]); a++) !n || b.nodeName(o, n) ? s.push(o)  : b.merge(s, Ot(o, n));
    ...
    b.extend({
        ...
        buildFragment: function (e, t, n, r) {
            ...
            h = 0;
            for (; p > h; h++) if (o = e[h], o || 0 === o) if ('object' === b.type(o)) b.merge(d, o.nodeType ? [
                o
            ] : o);
             else if (wt.test(o)) {
    ...
    b(function () {
        ...
        !b.support.pixelPosition && b.fn.position && b.each(['top',
        'left'], function (e, n) {
            b.cssHooks[n] = {
                get: function (e, r) {
