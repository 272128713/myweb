    ...
    */
    ...
    // ----------------------------------------------------------------------------
        ...
        this.imgFolder      = _PUBLIC+'/Home/images/dtree/';
        this.target             = null;
        this.hasLines           = true;
            ...
            for (var n=0; n<this.arrNodes.length; n++)
            {
                if (this.arrNodes[n].pid == pNode)
                {
                    ...
                    if (this.rootNode != cn.pid)
                    {
                        ...
                        if (cn._hc)
                        {
                            this.strOutput += '<a onfocus="this.blur()" href="javascript: ' + this.instanceName + '.o(' + n + ');">'
					...
					if(n>0)
					{
						this.strOutput += '<input type="radio" name ="dept_id" id = "'+this.arrNodes[n].pid+'" value="' + this.arrNodes[n].id + '" onclick ="selectDept(this.value)" onfocus="this.blur()">';
					}
                    ...
                    // Write out span
                    this.strOutput += '<span style="color:000000;font-family:����;font-size:12" id="s' + this.instanceName + n + '" class="' + ((this.clickSelect) ? ((cn._is ? 'nodeSel' : 'node')) : 'node') + '">';
...
//##################################################
    ...
    {
    	if(isHidden){
    		window.parent.document.getElementById('optAjaxData').value=deptid;
    	}
    	window.parent.optFrame.location=_URL+"/id/"+deptid;
    }
