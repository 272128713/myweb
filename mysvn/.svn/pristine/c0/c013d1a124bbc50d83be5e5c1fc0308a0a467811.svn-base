									...
									function uploadPicture<?php echo ($o_key); ?>(file, data){
										...
										if(data.status){
											...
											$("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').append(
												'<div class="upload-pre-item" val="' + data.id + '"><img src="/kospital/admin' + src + '" ondblclick="removePicture<?php echo ($o_key); ?>(this)"/></div>'
											);
														...
														function uploadPicture<?php echo ($o_tab_key); ?>(file, data){
															...
															if(data.status){
																...
																$("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').append(
																	'<div class="upload-pre-item" val="' + data.id + '"><img src="/kospital/admin' + src + '" ondblclick="removePicture<?php echo ($o_tab_key); ?>(this)"/></div>'
																);
