...
<div class="tab-wrap">
	<div class="tab-content">
        <!-- 标题-->
        <input type="text" id="title" class="text input-large" value="<?php echo ($result['jobname']); ?>" placeholder="请填写标题"/>
	<!-- 表单 -->
    </div>

    <!-- 加载编辑器的容器 -->
    <script id="container" name="content" type="text/plain">
<?php echo ($result['jobdetail']); ?>
    </script>
    ...
    <script type="text/javascript" src="/mysvn/kospital/admin/Public/static/ueditor.config.js"></script>
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="/mysvn/kospital/admin/Public/static/ueditor.all.min.js"></script>
    <!-- 实例化编辑器 -->
    <script type="text/javascript">
        ...
        $('#submit').click(function(){
            ...
            console.log(content);
            var id = <?php echo ($id); ?>;
            $.post("<?php echo U('editDo');?>",{'title':title,'content':content,'id':id},function(data){
                if(data>0){
