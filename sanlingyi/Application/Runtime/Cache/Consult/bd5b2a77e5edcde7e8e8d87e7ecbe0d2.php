...
<html>
	...
	<body>
		...
		<header class="mui-bar mui-bar-nav" style="position: fixed;">
			...
			<h1 class="mui-title" style="" onclick="logoutConsultings('')">在线义诊</h1>
            <div class="right">
                <!--<a href="<?php echo U('SelfConsult/index');?>"><img src="/sanlingyi/Public/Consult/images/jilu.png" class="jiluzixun" /></a>-->
                <a href="<?php echo U('Search/index');?>"><img src="/sanlingyi/Public/Consult/images/jilu1(2).png" class="jiluzixun" /></a>
            </div>
		</header>
        ...
        -->
	        <div class="mui-pull-left mui-segmented-control cc">
				<a href="<?php echo U('docindex',array('svalue'=>$search));?>" class="mui-control-item <?php if(!isset($_GET['type'])) echo 'mui-active'; ?>">新提问</a>
				<a href="<?php echo U('docindex',array('type'=>1,'svalue'=>$search));?>" class="mui-control-item <?php if($_GET['type']==1) echo 'mui-active'; ?> ">已解答</a>
				<a href="<?php echo U('docindex',array('type'=>2,'svalue'=>$search));?>" class="mui-control-item <?php if($_GET['type']==2) echo 'mui-active'; ?> ">问我的</a>
                <a href="<?php echo U('docindex',array('type'=>3,'svalue'=>$search));?>" class="mui-control-item <?php if($_GET['type']==3) echo 'mui-active'; ?> ">我的解答</a>
                <?php $type=$_GET['type']; ?>
            </div>
