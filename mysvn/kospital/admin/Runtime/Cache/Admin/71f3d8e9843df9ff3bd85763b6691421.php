...
<body>
    ...
    <div class="fl" style="margin-bottom: 20px">
        <button id="newadd" class="btn ajax-post" target-form="ids" url="<?php echo U('Hr/add');?>">新 增</button>
    </div>
    ...
    <div class="data-table">
        <table class="">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["jobname"]); ?> </td>
                    <td><?php echo ($vo["createdate"]); ?> </td>
                    <td><a href="<?php echo U('Hr/edit?id='.$vo['id']);?>">编辑</a>
                        <a href="<?php echo U('Hr/delete?id='.$vo['id']);?>" class="confirm ajax-get" onclick="setTimeout(window.location.reload(),2)">删除</a>
                    </td>
...
//            if(confirm("确认删除？")){
//
//                window.location.href = "<?php echo U('Hr/delete');?>"+'/id/'+data;
//            }else{
//            }
//
//        }
