...
<html>
	...
	<body>
		...
		<div class="content" style="margin-bottom: 50px;">
			...
			<div class="search" style="margin-bottom: 32px">
			...
			<div class="paging">
                <?php if($num==0){ }else{
                    ...
                    ?>
                    <a class="pre" href="search_list.php?vl=<?php echo $vl;?>&page=1"></a>
                    <a class="behindto" href="search_list.php?vl=<?php echo $vl;?>&page=<?php echo $pagebehind;?>"></a>
                    <?php

                        pagebar($num,$page+1,9,$vl);
                    ?>
                    <a class="nextto" href="search_list.php?vl=<?php echo $vl;?>&page=<?php echo $pagenext;?>"></a>
                    <a class="last" href="search_list.php?vl=<?php echo $vl;?>&page=<?php echo $num;?>"></a>
                <?php }?>
                <div class="clearfix"></div>
			</div>
		</div>
 ...
 * $num 显示的页码数
 **/
function pagebar($count, $page, $num, $vl) {
    ...
    for($i=$start; $i<=$end; $i++) { //输出分页条，请自行添加链接样式
        ...
        echo "<a ".$active." href='search_list.php?vl=".$vl."&page=".$i."'>" . $i . "</a>";
