...
<head>
    ...
    <link href="/kospital/admin/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/kospital/admin/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/kospital/admin/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/kospital/admin/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/kospital/admin/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/kospital/admin/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/kospital/admin/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/kospital/admin/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/kospital/admin/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script type="text/javascript" src="/kospital/admin/Public/static/uploadify/jquery.uploadify.min.js"></script>
...
<div class="tab-wrap">
                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value=""><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
									...
									<?php if(!empty($data[$field['name']])): ?><div class="upload-pre-item"><img src="/kospital/admin<?php echo (get_cover($data[$field['name']],'path')); ?>"/></div><?php endif; ?>
									</div>
								</div>
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/kospital/admin/Public/static/uploadify/uploadify.swf",
								...
								function uploadPicture<?php echo ($field["name"]); ?>(file, data){
							        ...
							        if(data.status){
							        	...
							        	src = data.url || '/kospital/admin' + data.path;
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/kospital/admin", //当前网站地址
            "APP"    : "/kospital/admin/index.php", //当前项目地址
            "PUBLIC" : "/kospital/admin/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/kospital/admin/Public/static/think.js"></script>
    <script type="text/javascript" src="/kospital/admin/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/kospital/admin/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/kospital/admin/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/kospital/admin/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/kospital/admin/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/kospital/admin/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
