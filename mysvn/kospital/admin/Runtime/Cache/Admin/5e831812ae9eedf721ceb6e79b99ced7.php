...
<script>
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入表单主题">
    ...
    <div class="data-table">
        <table class="">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td style="width: 300px;word-break: break-all"><?php echo ($vo["title"]); ?> </td>
                    <td style="width: 500px;word-break: break-all"><?php echo ($vo["content"]); ?> </td>
