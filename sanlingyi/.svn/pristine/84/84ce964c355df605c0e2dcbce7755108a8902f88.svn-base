function imenus_data0()
{
   ...
   ---------------------------------------------*/
	...
	this.box_animation_styles = "border-style:solid; border-color:#2F5084; border-width:1px";
...
function imenus_box_ani_init(obj,dto)
{
	...
	{
		ulm_boxa["go"+tid]=true;ulm_boxa.go=true;ulm_boxa.all=new Object();
	}
	else return;
}
...
{
	var a=bo.bdiv;var cx=bo.sxy[0]+parseInt((bo.dxy[0]/bo.steps)*bo.pos);
...
if(!ulm_oldnav)document.write('<style type="text/css">.imcm .imunder{position:absolute;width:100%;z-index:-1;}</style>');
else document.write('<style type="text/css">.imcm .imunder{display:none;}</style>');
imenus_under();
