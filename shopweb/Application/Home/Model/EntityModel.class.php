...
class EntityModel extends  Model{
    ...
    */
    ...
    public  function  getDocList($hid){
        $db=M('com_sic_region_info');
        $sql="SELECT a.doctor_id,b.user_name,b.recollection_id,b.duty_id ,b.hospital,
        ...
        foreach($arr as $k=>$v){
            ...
            //k服务购买个数
            $count=M()->query('select count(*) as service_num from k_user_buy WHERE docId='.$v['doctor_id'].
