...
{var _this=this;this.wrap=typeof id==="string"?document.getElementById(id):id;this.oUl=this.wrap.getElementsByTagName("ul")[0];
this.aLi=this.wrap.getElementsByTagName("li");this.prev=this.wrap.getElementsByTagName("pre")[0];
this.next=this.wrap.getElementsByTagName("pre")[1];this.timer=null;this.aSort=[];
this.iCenter=3;
this._doPrev=function(){return _this.doPrev.apply(_this)};
this._doNext=function(){return _this.doNext.apply(_this)};
this.options=[
{width:333,height:233,top:17,left:0,zIndex:1},
{width:333,height:233,top:17,left:0,zIndex:2},
{width:333,height:233,top:17,left:0,zIndex:3},
{width:383,height:267,top:0,left:333,zIndex:4},
{width:333,height:233,top:17,left:716,zIndex:3},
{width:333,height:233,top:17,left:716,zIndex:2},
{width:333,height:233,top:17,left:716,zIndex:1},];
for(var i=0;i<this.aLi.length;i++)this.aSort[i]=this.aLi[i];this.aSort.unshift(this.aSort.pop());this.setUp();
this.addEvent(this.prev,"click",this._doPrev);this.addEvent(this.next,"click",this._doNext);
this.doImgClick();this.timer=setInterval(function()
