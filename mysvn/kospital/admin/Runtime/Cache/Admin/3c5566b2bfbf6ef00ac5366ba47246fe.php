...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录Kospital管理后台</title>
        <link rel="stylesheet" type="text/css" href="/mysvn/kospital/admin/Public/Admin/css/login.css" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>Kospital管理平台</h3>
