...
<script>
	...
	<script type="text/javascript" src="/mysvn/kospital/admin/Public/static/uploadify/jquery.uploadify.min.js"></script>
                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
									...
									<?php if(!empty($data[$field['name']])): ?><div class="upload-pre-item"><img src="/mysvn/kospital/admin<?php echo (get_cover($data[$field['name']],'path')); ?>"/></div><?php endif; ?>
									</div>
								</div>
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/mysvn/kospital/admin/Public/static/uploadify/uploadify.swf",
								...
								function uploadPicture<?php echo ($field["name"]); ?>(file, data){
							        ...
							        if(data.status){
							        	...
							        	src = data.url || '/mysvn/kospital/admin' + data.path
...
<link href="/mysvn/kospital/admin/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/mysvn/kospital/admin/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/mysvn/kospital/admin/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/mysvn/kospital/admin/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/mysvn/kospital/admin/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
