		...
		<div class="container">
			<div class="tab">
				<div id="segmentedControl" class="mui-segmented-control">
					<a class="mui-control-item mui-active" href="#item1" style="line-height: 15px;height: 15px">最新公益</a>
					<a class="mui-control-item" href="#item2" style="line-height: 15px;height: 15px">我的公益</a>
				</div>
			</div>
			<div class="inner">
