<?php if (!defined('THINK_PATH')) exit(); if(is_array($news)): foreach($news as $key=>$v): ?><div class="art-box-list">
        ...
        <div class="time">
            ...
            <div class="jh">
                <?php if($v['report_flag']==0){ $model=D('Article'); $img=$model->getImg($v['id']); $v['img_url']= $img[0]['source_image_url']; $v['img_id']= $img[0]['article_image_id']; $data=json_encode($v); $name='data'.$key; ?>
                <script>
