...
<head>
	...
	<link rel="stylesheet" href="/kospital/admin/Public/admin/js/codemirror/codemirror.css">
	<link rel="stylesheet" href="/kospital/admin/Public/admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
	<style>
		...
		#preview_window.loading{
			background: url('/kospital/admin/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
'model'=>'Example',		//要查的表
	...
	<script type="text/javascript" src="/kospital/admin/Public/admin/js/codemirror/codemirror.js"></script>
	<script type="text/javascript" src="/kospital/admin/Public/admin/js/codemirror/xml.js"></script>
	<script type="text/javascript" src="/kospital/admin/Public/admin/js/codemirror/javascript.js"></script>
	<script type="text/javascript" src="/kospital/admin/Public/admin/js/codemirror/clike.js"></script>
	<script type="text/javascript" src="/kospital/admin/Public/admin/js/codemirror/php.js"></script>

	<script type="text/javascript" src="/kospital/admin/Public/static/thinkbox/jquery.thinkbox.js"></script>
