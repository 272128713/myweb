...
class upmp_config
{
  ...
  //测试
//    static $mer_id     				= "880000000002182"; // 商户号
//    static $security_key    		= "J1xkfuLh7GltrDapBesX05ANQUulB8v3"; // 商户密钥
//    static $mer_back_end_url     	= "http://117.34.72.251/unionpay/notify_url.php"; // 后台通知地址
//    static $mer_front_end_url     	= "http://117.34.72.251/unionpay/get.php"; // 前台通知地址
//
...
//    static $upmp_query_url    	 	= "http://202.101.25.178:8080/gateway/merchant/query";
    //正式
    static $mer_id     				= "898111148160304"; // 商户号
     static $security_key    		= "0dsQd9O87WacfRKFBmQ5MK1zIKUCsG2b"; // 商户密钥
    //static $mer_back_end_url     	= "http://117.34.72.251/unionpay/notify_url.php"; // 后台通知地址
    //static $mer_front_end_url     	= "http://117.34.72.251/unionpay/get.php"; // 前台通知地址
