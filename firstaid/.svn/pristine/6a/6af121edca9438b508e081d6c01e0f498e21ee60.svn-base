...
class ErrCode{	
	...
	const API_ERR_LINKMAN_IS_LINK		="4407";		//已经是该用户的监护人
	...
	const API_ERR_EG_ORDER_NO			  = "7008";		//订单不存在
	...
	private static  $hashmap=array("9998"=>"系统错误","9999"=>"参数错误 ","1001"=>"用户名格式不对","1002"=>"用户名已经存在,请直接登录","1003"=>"该账号需要picode验证 ","1004"=>"注册次数太多"
			...
			"1018"=>"email不存在","1019"=>"没有访问个人健康资料权限","1020"=>"生成注册码太快","1023"=>"缺少支付密码","1024"=>"","1025"=>"图片下载失败","1026"=>"上传失败","1027"=>"通讯录格式不对",
			"1028"=>"通讯录上传失败","1031"=>"该用户需要认证","1032"=>"该用户不存在","1033"=>"等待验证状态","1034"=>"添加分组错误","2001"=>"文件大小超过限制",
			...
			"4003"=>"获取医粉圈医生基本信息失败","4004"=>"获取医信用户的基本信息失败","4005"=>"获取好友基本信息","4006"=>"获取好友个人信息失败","4404"=>"失联人非法或无效","4406"=>"已经发送过主动监护请求","4407"=>"已是该目标监护人",
