...
<html>
	...
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="/shop_skyhospital/trunk/shopweb/Public/Article/css/pull.css"/>
	</head>
 ...
 */
		...
		<header class="mui-bar mui-bar-nav">
			<a class="mui-icon mui-icon-left-nav mui-pull-left" href="<?php echo U('Index/index');?>"></a>
		...
		<div class="mui-content" >
		   <div style="margin-top:0.8em">
        		...
        		<div style="margin-left:3.8em;padding-top: 0.5em;">
        			<div><?php echo ($me["member_truename"]); ?></div>

        		</div>
		   </div>
            <div class="leftline mui-pull-left" ></div>
            <?php
 $count=count($mc); $page=C('PAGE_NUM'); ?>
            <?php
 if($count>10){ ?>
            <div id="wrapper">
                <div id="scroller">
 ...
 if($count>=$page){ ?>
        ...
        <?php
 if($count>=$page){ ?>
        <script src="/shop_skyhospital/trunk/shopweb/Public/Article/js/iscroll.js"></script>
