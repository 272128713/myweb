...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/sanlingyi/Public/Consult/css/self-consult.css"/>
	...
	<body>
        ...
        -->
 		...
 		<img class="hdline" src="/sanlingyi/Public/Consult/images/line.png" />
        <div class="mui-segmented-control cc">
			<a href="<?php echo U('index');?>" class="mui-control-item <?php if(!isset($_GET['type']) or $_GET['type']==2 ) echo 'mui-active'; ?>">未解决</a>
			<a href="<?php echo U('index',array('type'=>1));?>" class="mui-control-item <?php if($_GET['type']==1) echo 'mui-active'; ?> ">已解决</a>
            <?php $type=$_GET['type']; ?>
        </div>
                            ...
                            <a href="<?php echo U('Index/detail',array('aid'=>$v['question_id']));?>" class="mui-navigate-right">
                                ...
                                <div class="ti"><?php echo ($v["title"]); ?><span>（<?php echo get_sex($v['sex']); ?> <?php echo ($v["age"]); ?>岁）</span>
                                    <div class="clear tifoot"><?php echo ($v["recollection"]); ?>、<?php echo ($v["disease"]); ?>
                                        <div class="right"><?php echo substr($v['createDate'],0,10); ?>&nbsp;&nbsp;&nbsp;&nbsp;回复 <span class="red"><?php echo ($v["recommend_num"]); ?></span></div>
                                    </div>
                                </div>
                            </a>
