...
<html>
	...
	<body>
		<div class="container">
				...
				<div class="item_t">
					...
					<div class="number">
						<div class="sale">
							...
							已销售<?php echo $goods["goods_sell_nums"]?>件
						</div>
						<!-- div class="goodcom">
			...
			<div class="goods_content" style="padding:0 2% 0 2%;font-size:14px;color:#333">
				<?php 
				if($goods['goods_content']){
					echo $goods['goods_content'];
				}else{
					echo "<div style='font-size:13px;line-height:1.5em;text-indent:2%;color:#999;margin-bottom:3em;'>暂无介绍！</div>";
				}
				?>
			</div>
			<div class="fixed" style="border:0">
				...
				<div class="fr fr2" style="border:0;width:100%;height:50px" onclick="window.location.href='emergency_shoppingcart.php?gid=<?php echo $goods['id']?>'">立即拥有</div>
				<div class="clearfix"></div>
			</div>
		</div>
